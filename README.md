# IGSN Publisher MVP
Serving sample data with the minimum of fuss since October 2019

[![Build Status](https://travis-ci.com/IGSN/igsn-publisher-mvp.svg?branch=master)](https://travis-ci.com/IGSN/igsn-publisher-mvp)
...
{
    "message": "IGSN Demo Publisher up and running!"
}
```
...
```bash
$ pipenv run "python -m ipykernel install --user --name=igsn-publisher-mvp"
```

and you should be able to see the igsn-publisher-mvp kernel in jupyter.
